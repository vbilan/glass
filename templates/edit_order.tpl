...
{if ($order.id)}
    <tr><td colspan=2><div style="text-align:center; font-size:16pt; font-weight: 800; margin:10px;">Замовлення № {$order.id%1000} {if ($order.username)} ({$order.username}){/if} </div></td></tr>
{/if}
	<tr>
        ...
        <table>
            <tr>
                ...
                <td>
                {if ($order.phone)} тел. {$order.phone}){/if}
                </td>
            </tr>
        </table>
	...
	<tr>
		...
		<td align="left" class="oddcolumn">
			<input type="text" name="advance_fixed" value="{$order.advance_fixed}" maxlength="20" />
		</td>					
	</tr>
	<tr>
		<td align="right" class="evencolumn"> Оплачено </td>
		<td align="left" class="oddcolumn">
			<input type="text" name="advance" value="{$order.advance}" maxlength="20" onchange="refres_must_pay();"; />
			<input type="hidden" name="advance_old" value="{$order.advance}"/>
		</td>					
	</tr>
	<tr>
		<td align="right" class="evencolumn"> Оплатити </td>
		<td align="left" class="oddcolumn"><input id='must_pay' disabled type="text" value="{$order.price-$order.advance}" maxlength="20" /></td>	
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left" class="oddcolumn"><input type="checkbox" name="done" {if ($order.done)}checked="checked"{/if} /></td>					
	</tr>
	<tr>
		<td align="right" class="evencolumn">Забрано </td>
		<td align="left" class="oddcolumn"><input type="checkbox" name="closed" {if ($order.closed)}checked="checked"{/if} /></td>					
	</tr>
	<tr>
		<td align="right" class="evencolumn">Терміново </td>
		<td align="left" class="oddcolumn"><input type="checkbox" name="urgent" {if ($order.urgent)}checked="checked"{/if} /></td>					
	</tr>	
	<tr>
		<td align="right" class="evencolumn">Виконати до</td>
		<td align="left" class="oddcolumn"><input style="width:80px;" id="till_date" name="till_date" value="{$order.till_date}" maxlength="10" type="type"> <a href="javascript:NewCssCal('till_date','ddmmyyyy')"><img style="border:none;" src="images/cal.gif" height="16" width="16"></a></td>					
	</tr>	
