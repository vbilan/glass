	...
	<td colspan='2'>
		<table cellpadding="0" cellspacing="0" border="1" width="100%">
			...
			<tr {if (!$row.date)}id="1" onclick="change_visibility(this);"{else}class="hiddenrow"{/if}>
				...
				<td align="center" class="totaldata">{$row.price|number_format:2:",":" "}&nbsp; </td>
				<td align="center" class="totaldata">&nbsp; </td>
				...
				<td align="center" class="sumdata">{$row.square|number_format:2:",":" "}&nbsp; </td>
				<td align="center" class="sumdata">{$row.price|number_format:2:",":" "}&nbsp; </td>
				<td align="center" class="sumdata">&nbsp; </td>
				{else}
				<td align="center" class="evencolumn">&nbsp;</td>
				<td align="center" class="oddcolumn">{$row.square|number_format:2:",":" "}&nbsp; </td>
				<td align="center" class="evencolumn">{if ($row.price)}{$row.price|number_format:2:",":" "} {else} <small>списано</small>{/if}&nbsp;</td>
