	...
	<td colspan='2'>
		<table cellpadding="0" cellspacing="0" border="1" width="100%">
			...
			<tr>
				...
				<td align="center" class="oddcolumn">{$row.phone}&nbsp;</td>
				<td align="center" class="evencolumn">{if $row.actual == 1}так{else}ні{/if}&nbsp;</td>
				<td align="center" class="oddcolumn"  width="100px;">
				<a href="index.php?action=edit_client&id={$row.id}">Редагувати</a>
				<br />
				<a href="index.php?action=edit_client&id={$row.id}&delete"  onclick="return confirm('Ви дійсно бажаєти видалити цей запис?');">Видалити</a>
				</td>					
			</tr>
			{/foreach}
