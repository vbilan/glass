		...
		<table cellpadding="0" cellspacing="0" border="1" width="100%">
			...
			<tr>
				...
				<td align="center" class="evencolumn"  width="100px;">
					<a href="index.php?action=edit_good&id={$row.id}">Редагувати</a>
					<br />
					<a href="index.php?action=edit_good&id={$row.id}&delete"  onclick="return confirm('Ви дійсно бажаєти видалити цей запис?');">Видалити</a>
				</td>					
			</tr>
			{/foreach}
