	...
	<td colspan='2'>
		<table cellpadding="0" cellspacing="0" border="1" width="100%">
			...
			<tr {if (!$row.date)}id="1" onclick="change_visibility(this);"{else}class="hiddenrow"{/if}>
				...
				<td align="center" class="evencolumn">{if ($row.price)}{$row.price|number_format:0:",":" "} {else} <small>списано</small>{/if}&nbsp;</td>
				<td align="center" class="oddcolumn"><a href="index.php?action=edit_order&id={$row.num}">№ {$row.num%1000}</a></td>
