...
function updatePage() {
	...
	function adddrilling2(size, drilling_count, price, j){
			...
			s+='\n<td width="50px;"><input id="drilling_price_'+j+'_'+size+'" style="width:50px;" onchange="calc_drilling_price(\''+j+'_'+size+'\','+j+')" name="sellings['+j+'][drilling][price]" value="'+drilling_prices[size]+'" /></td>';
	...
	function add_selling2(height, width, count, good_type, label, price){
		...
		+'\n<td class="column">'+label+' (S='+width*height/1000000+')</td>'
		...
		+'\n<td class="column" width="90px;"> к-сть  <strong>'+count+'</strong> (S='+count*width*height/1000000+')<input  value="'+count+'" id="count'+i+'" type="hidden" name="sellings['+i+'][count]" value="1"/></td>'
