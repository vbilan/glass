...
var WeekDayColor="#FEEF89";//Background color of weekdays.
...
var CalBgColor="#0011FF";//Background color of Calendar window.
...
var WeekDayName1=["Неділя","Понеділок","Вівторок","Середа","Четвер","Пятниця","Субота"];
var WeekDayName2=["Понеділок","Вівторок","Середа","Четвер","Пятниця","Субота","Неділя"];
