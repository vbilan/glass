<?php /* Smarty version 2.6.26, created on 2014-08-29 17:01:46
...
?>
			<tr>
				<td class="evencolumn"><?php echo $this->_tpl_vars['row']['login']; ?>
&nbsp;</td>
				<td align="center" class="oddcolumn"><?php if ($this->_tpl_vars['row']['admin'] == 1): ?>так<?php else: ?>ні<?php endif; ?>&nbsp;</td>
				...
				<a href="index.php?action=edit_user&id=<?php echo $this->_tpl_vars['row']['id']; ?>
">Редагувати</a>
				<br />
				<a href="index.php?action=edit_user&id=<?php echo $this->_tpl_vars['row']['id']; ?>
&delete"  onclick="return confirm('Ви дійсно бажаєти видалити цей запис?');">Bидалити</a>
				</td>					
			</tr>
			<?php endforeach; endif; unset($_from); ?>
