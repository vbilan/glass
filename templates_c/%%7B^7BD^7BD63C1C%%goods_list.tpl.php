<?php /* Smarty version 2.6.26, created on 2016-09-05 17:33:12
         compiled from goods_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'goods_list.tpl', 43, false),)), $this); ?>
<table width="100%" >
<tr>
	<td  align="left">
		<a href="index.php?action=edit_good">Додати</a>
	</td>
	<td align="right">
...
&nbsp; </td>	
				<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['name']; ?>
&nbsp;</td>
				<td align="center" class="evencolumn"><?php echo $this->_tpl_vars['row']['square']; ?>
&nbsp;<?php echo $this->_tpl_vars['row']['unit_of_measurement']; ?>
 </td>
				
				<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['buying_price']; ?>
&nbsp;</td>
				<td align="center" class="evencolumn"><?php echo $this->_tpl_vars['row']['buying_amount']; ?>
&nbsp;</td>
...
&nbsp;</td>
				...
				<td align="center" class="evencolumn"  width="100px;">
					<a href="index.php?action=edit_good&id=<?php echo $this->_tpl_vars['row']['id']; ?>
">Редагувати</a>
					<br />
					<a href="index.php?action=edit_good&id=<?php echo $this->_tpl_vars['row']['id']; ?>
