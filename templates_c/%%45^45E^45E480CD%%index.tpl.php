<?php /* Smarty version 2.6.26, created on 2014-08-28 22:16:51
...
?> 
			      	<?php if (( ! $this->_tpl_vars['value']['hide'] && ! ( $this->_tpl_vars['value']['admin'] && ! $this->_tpl_vars['admin'] ) )): ?>
	        			&nbsp;
	        			<font color="#FF0000"><span class="small">o</span></font>
	        			<a class="nav" href="index.php?action=<?php echo $this->_tpl_vars['value']['action']; ?>
        ...
        cellPadding="0" cellSpacing="0" width="100%">
          <tr>
            <td ><table border="0" cellpadding="8" cellspacing="1" width="100%">
              <tr>
                <td align="center" ><?php echo $this->_tpl_vars['content']; ?>
</td>
              </tr>
            </table>
            </td>
