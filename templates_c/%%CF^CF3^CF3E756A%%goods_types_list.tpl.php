<?php /* Smarty version 2.6.26, created on 2016-09-15 17:42:58
         compiled from goods_types_list.tpl */ ?>
<table width="100%" >
<tr>
	<td  align="left">
		<a href="index.php?action=edit_goods_type">Додати</a>
	</td>
	<td align="right">
...
&nbsp;</td>
				<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['gr_name']; ?>
&nbsp<?php echo $this->_tpl_vars['row']['uom']; ?>
</td>
				<td align="center" class="evencolumn"><?php if ($this->_tpl_vars['row']['actual'] == 1): ?>так<?php else: ?>ні<?php endif; ?>&nbsp;&nbsp;</td>
				<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['smash_percent']; ?>
&nbsp;%.</td>
				<td align="center" class="evencolumn"><?php echo $this->_tpl_vars['row']['price']; ?>
&nbsp;Грн.</td>
				<td align="center" class="oddcolumn"  width="100px;">
				<a href="index.php?action=edit_goods_type&id=<?php echo $this->_tpl_vars['row']['id']; ?>
">Редагувати</a>
				<br />
				<a href="index.php?action=edit_goods_type&id=<?php echo $this->_tpl_vars['row']['id']; ?>
