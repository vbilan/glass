<?php /* Smarty version 2.6.26, created on 2014-08-29 13:45:14
         compiled from report_by_goods.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'report_by_goods.tpl', 32, false),array('modifier', 'date_format', 'report_by_goods.tpl', 46, false),)), $this); ?>
<div class="report_header" style="">Приходи товару на склад</div>
...
?>
			<tr <?php if (( ! $this->_tpl_vars['row']['date'] )): ?>id="1" onclick="change_visibility(this);"<?php else: ?>class="hiddenrow"<?php endif; ?>>
				...
				<td align="center" class="totaldata"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['price'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ' ') : number_format($_tmp, 2, ",", ' ')); ?>
&nbsp; </td>
				<td align="center" class="totaldata">&nbsp; </td>
...
&nbsp; </td>
				<td align="center" class="sumdata"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['price'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ' ') : number_format($_tmp, 2, ",", ' ')); ?>
&nbsp; </td>
...
&nbsp; </td>
				<td align="center" class="evencolumn"><?php if (( $this->_tpl_vars['row']['price'] )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['price'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ' ') : number_format($_tmp, 2, ",", ' ')); ?>
