<?php /* Smarty version 2.6.26, created on 2014-09-11 11:15:23
         compiled from report_service_balanse.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'report_service_balanse.tpl', 34, false),array('modifier', 'date_format', 'report_service_balanse.tpl', 48, false),)), $this); ?>
<div class="report_header" style="">Звіт по послугах</div>
...
&nbsp; </td>
				...
				<td align="center" class="sumdata"><?php echo $this->_tpl_vars['row']['name']; ?>
&nbsp;</td>
...
">№ <?php echo $this->_tpl_vars['row']['num']; ?>
				...
				<td align="center" class="oddcolumn"><a href="index.php?action=edit_client&id=<?php echo $this->_tpl_vars['row']['client']; ?>
"><?php echo $this->_tpl_vars['row']['client_name']; ?>
</a>&nbsp;</td>
				<td align="center" class="evencolumn"><a href="index.php?action=edit_order&id=<?php echo $this->_tpl_vars['row']['order_id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['amount'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
&nbsp;</a> </td>
				<?php endif; ?>
				<?php endif; ?>
			</tr>
