<?php /* Smarty version 2.6.26, created on 2014-10-14 11:28:34
         compiled from report_by_spending.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'report_by_spending.tpl', 32, false),array('modifier', 'date_format', 'report_by_spending.tpl', 42, false),)), $this); ?>
...
&nbsp; </td>
						<td align="center" class="sumdata"><?php echo $this->_tpl_vars['row']['comment']; ?>
&nbsp; </td>
					<?php else: ?>
...
&nbsp; </td>
						<td align="center" class="evencolumn"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['amount'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
&nbsp;</td>
						<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['comment']; ?>
&nbsp;</td>
					<?php endif; ?>
				<?php endif; ?>
			</tr>
