<?php /* Smarty version 2.6.26, created on 2014-08-29 13:06:41
         compiled from client_list.tpl */ ?>
<table width="100%" >
<tr>
	<td  align="left">
		<a href="index.php?action=edit_client">Додати</a>
	</td>
	<td align="right">
...
&nbsp;</td>
				<td align="center" class="oddcolumn"><?php echo $this->_tpl_vars['row']['phone']; ?>
&nbsp;</td>
				...
				<a href="index.php?action=edit_client&id=<?php echo $this->_tpl_vars['row']['id']; ?>
">Редагувати</a>
				<br />
				<a href="index.php?action=edit_client&id=<?php echo $this->_tpl_vars['row']['id']; ?>
